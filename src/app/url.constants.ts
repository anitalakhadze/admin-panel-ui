...
export const INACTIVE_COMPANIES_ENDPOINT = COMPANIES_ENDPOINT + "?statuses=INACTIVE";
export const ACTIVE_COMPANIES_ENDPOINT = COMPANIES_ENDPOINT + "?statuses=ACTIVE";
